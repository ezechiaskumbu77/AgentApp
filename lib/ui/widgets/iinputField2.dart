  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: new TextFormField(
        ...
        keyboardType: widget.code == "+243" || widget.icon == Icons.addchart_sharp ||  widget.icon == Icons.account_balance_wallet_outlined ||  widget.icon ==  Icons.monetization_on_outlined ?  TextInputType.number : widget.type ,//widget.type,
