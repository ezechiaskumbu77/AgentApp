...
class ICard27 extends StatefulWidget {
  ...
  final Function(OrderPPCModel ord) callback;
  ...
  ICard27({this.order ,this.color = Colors.white, this.colorRoute = Colors.black,
    this.id = "",
...
class _ICard27State extends State<ICard27>{
  ...
  Widget build(BuildContext context) {
        print("see the order : ${widget.order.customer}");
