...
//            Text(widget.text2, style: _text2Style, overflow: TextOverflow.ellipsis,),
                ...
                child: ClipRRect(
                  ...
                  child:Container(
                    child: CachedNetworkImage(
                      ...
                      imageUrl: item.name=="Surecast" ? item.image : "https://ppc-jhb-web.azureedge.net/website/attachments/cjp2enumr019u0fqtwjfr3amx-surecem.full.png",
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10,),
                  Text("${item.price.toStringAsFixed(2)} ${item.currency} х ${item.count} = ${item.price*item.count} ${item.currency}", style: _text2Style,),
                ],)),
            )
    ...
    list.add(Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Text("${widget.text3}: $_total $currency", style: _text3Style,),
            SizedBox(height: 10,),
          // Text(widget.text4, style: _text3Style,),
        //    SizedBox(height: 10,),
           // Text(widget.text5, style: _text3Style,),
            SizedBox(height: 10,),
            Text("${widget.text6} FC ", style: _text6Style,),
            Text("#Le total inclus la livraison "),
          ],
        )
    )
    );
