...
class AddProductSales extends StatefulWidget {
  ...
  AddProductSales({Key key, this.shop, this.product }) : super(key: key);
  @override
  _AddProductSalesState createState() => _AddProductSalesState();
}

class _AddProductSalesState extends State<AddProductSales>
  ...
  _pressCreateAccountButton() async{
    ...
    if( editcontrolNumber.text.isEmpty  || editControlprice.text.isEmpty){
     ...
     // print("name : ${editcontrolName.text} et devise ${_devise}");
      ...
      _saleStockModel.productStock = widget.product.id;
