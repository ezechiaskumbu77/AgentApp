...
class EditShopScreen extends StatefulWidget {
 // final Function(String, Map<String, dynamic>) callback;
  var callback ;
  final ShopModel shopEdit;
  EditShopScreen({Key key, this.callback, this.shopEdit}) : super(key: key);
...
class _EditShopScreenState extends State<EditShopScreen> {
 ...
 //   widget.callback(_getStringParam("backRoute"), {});
  ...
  _initEditControllers(){
    ...
    // editControllerName.text =   shop.name ;//_getStringParam("name");
    // editControllerAddress.text =    shop.address ;//_getStringParam("Address");
    // editControllerPhone.text =    " " ;//_getStringParam("phone");
    // editControllerMobilePhone.text =   "" ;//_getStringParam("mobilephone");
    // editControllerDesc.text =   shop.description ;//_getStringParam("desc");
  ...
  Widget _drawImage(){
    if (_imagePath.isNotEmpty)
      ...
      if (  false )//_getStringParam("image").isNotEmpty)
      return Container(
