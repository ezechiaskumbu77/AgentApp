...
class Header extends StatefulWidget {
  ...
  Header({Key key, this.title, this.onMenuClick, this.nomenu = false, this.white = false,
    this.transparent = false, this.callback, this.userL}) : super(key: key);
  @override
        ...
        child: Row(
          children: <Widget>[
            ...
            if (account.isAuth())
              ...
              //"https://secure-sea-91184.herokuapp.com/uploads/${widget.userL.photo_url== null ? "photo_user.png":  widget.userL.photo_url}"
    ...
    return Container(
      ...
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: Container(
            child: Icon(Icons.person, color: Colors.black,)/*CachedNetworkImage(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Align(
                    alignment: Alignment.center,
                    child: Text('0', style: theme.text10white),
                    //account.notifyCount.toString()
                  ),
                ),
              )
