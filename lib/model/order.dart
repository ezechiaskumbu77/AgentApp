...
var orders = [
  Order(
    ...
    currency: "\$",
    summa: 212.23,
    method: "Payement à la livraison",
    distance: 0,
    address1: "Parc virunga 16 , Righini lemba Kinshasa, RDC",
    address1Latitude: 48.895605,
    address1Longitude: 2.087823,
    address2: "Beni 29 , Righini lemba Kinshasa, RDC",
    address2Latitude: 48.897379,
    address2Longitude: 2.094781,
    status: 1,
    phone: "+243811960037",
    customerName: "Jbsy Bonsuka",
    fee: 2.35,
    tax: 2.35,
    total: 23.55 - 4.7,
    orderDetails: [
  ...
  Order(
    ...
    currency: "\$",
    summa: 156.08,
    method: "Cache on Delivery",
    distance: 0,
    address1: "15 kwilu , C/Ngaba , Kinshasa , RDC",
    address1Latitude: 48.851332,
    address1Longitude: 2.636826,
    address2: "15 kwilu , C/Ngaba , Kinshasa , RDC",
    address2Latitude: 48.850905,
    address2Longitude: 2.344964,
    status: 2,
    phone: "+24381897647738",
    customerName: "Ikoli bombeli",
    fee: 2.35,
    tax: 2.35,
    total: 23.55 - 4.7,
    orderDetails: [
  ...
  Order(
    id: "215",
    date: "2020-07-08 15:06",
    currency: "\$",
    summa: 246.19,
    method: "Cache on Delivery",
    distance: 0,
    address1: "luvu 13 , super lemba , kinshasa RDC",
    address1Latitude: 48.87641,
    address1Longitude: 2.514941,
    address2: "",
    address2Latitude: 48.83981,
    address2Longitude: 2.519061,
    status: 4,
    phone: "+243974607630",
    customerName: "Marthe Miaka",
    fee: 2.35,
    tax: 2.35,
    total: 23.55 - 4.7,
    orderDetails: [
  ...
  Order(
    id: "216",
    date: "2020-07-08 16:56",
    currency: "\$",
    summa: 187.19,
    method: "Cache on Delivery",
    distance: 0,
    address1: "1 rue 30, Limete kinshasa, RDC",
    address1Latitude: 48.834559,
    address1Longitude: 2.362763,
    address2: "Avenue de la République 30 , Gombe kinshasa, RDC",
    address2Latitude: 48.865071,
    address2Longitude: 2.375525,
    status: 1,
    phone: "+243907049834",
    customerName: "Gauis Mulombo",
    fee: 2.35,
    tax: 2.35,
    total: 23.55 - 4.7,
    orderDetails: [
